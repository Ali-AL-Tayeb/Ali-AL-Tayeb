...
I'm a **Machine Learning Engineering student** focused on building practical ML systems from data preparation and model development to deployment and automation.

My interests sit at the intersection of **Machine Learning, Data Engineering, and Bioinformatics**, with a focus on developing reliable, scalable, and reproducible solutions using Python and modern ML tools.
...
[![My Skills](https://skillicons.dev/icons?i=python,pytorch,tensorflow,sklearn,cpp,mysql,docker,git,github,vscode,pycharm)](https://skillicons.dev)

## Currently Learning

[![My Skills](https://skillicons.dev/icons?i=aws,azure,matlab,linux,arch)](https://skillicons.dev)
...
I enjoy working on projects that go beyond training a model in a notebook — from **data collection and preprocessing to model development, evaluation, deployment, and automation**.

My goal is to build ML systems that are not only accurate, but also **reproducible, maintainable, and useful in real-world applications**.
